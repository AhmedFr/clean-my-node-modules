...
const TITLE = "Clean my node_modules — reclaim your disk from node_modules";
const DESCRIPTION =
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Clean my node_modules — a macOS menu bar app that reclaims disk space from node_modules",
      },
    ],
  },
  twitter: {
